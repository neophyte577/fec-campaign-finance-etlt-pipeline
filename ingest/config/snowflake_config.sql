...
CREATE OR REPLACE DATABASE fec;
CREATE OR REPLACE ROLE fec_role;

GRANT usage ON WAREHOUSE fec_wh TO ROLE fec_role;
GRANT ROLE fec_role TO USER neophyte577;
GRANT ALL ON DATABASE fec TO ROLE fec_role;

USE ROLE fec_role;

CREATE OR REPLACE SCHEMA fec.raw;
CREATE OR REPLACE SCHEMA fec.transformed;
...
GRANT CREATE STAGE ON SCHEMA fec.raw TO ROLE fec_role;
